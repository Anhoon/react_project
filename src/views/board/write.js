          ...
          <form onSubmit={handleSubmit}>
            ...
            <CardContent>
                <Grid container spacing={1}>
                  ...
                  <Grid item md={6} xs={12}>
                    <TextField
                      fullWidth label="작성자" name="contents" onChange={handleChange} onBlur={handleBlur} required
                      value={values.name} variant="outlined" 
                    />
                  </Grid>
                  <Grid item md={12} xs={12}>
                    <TextField
                      fullWidth label="내용" name="content" onChange={handleChange} onBlur={handleBlur} required
                      value={values.name} variant="outlined" multiline 
                    />
                  </Grid>
                </Grid>
              </CardContent>
